...
# Extended seeds for 3-state conditioned Transformer VAE.
...
echo "========================================================"
echo "  Transformer VAE — Conditioned Extended Seeds (3-state)"
echo "========================================================"
...
# ── Generate candidates ─────────────────────────────────────────────────
echo ""
echo "Generating 200 candidates per state (3 states x 200 = 600 total, seed=${SEED})..."
