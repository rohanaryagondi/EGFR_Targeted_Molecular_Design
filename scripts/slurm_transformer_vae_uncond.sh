...
# Train unconditioned Transformer VAE across 3 seeds (Ablation C null hypothesis).
#
...
#   2. Trains unconditioned Transformer VAE (n_states=1)
#   3. Generates 300 candidates (1 state x 300 = 300 total)
#
# Prerequisites:
#   - data/processed/egfr_smiles_unconditioned_train.json exists
#   - data/processed/egfr_smiles_unconditioned_val.json exists
...
echo "========================================================"
echo "  Transformer VAE — Unconditioned Training (Ablation C)"
echo "========================================================"
...
# ── Generate candidates ─────────────────────────────────────────────────
echo ""
echo "Generating 300 candidates (unconditioned, seed=${SEED})..."
