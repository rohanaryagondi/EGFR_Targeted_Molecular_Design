...
# Ablation C v3: Transformer VAE conditioned vs unconditioned.
...
echo "========================================================"
echo "  Ablation C v3 — Transformer VAE"
...
if [ "${SLURM_ARRAY_TASK_ID}" -eq 0 ]; then
    ...
    python scripts/run_ablation_c_analysis_v3.py
