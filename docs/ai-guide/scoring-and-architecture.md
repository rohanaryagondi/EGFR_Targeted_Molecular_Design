...
| docking_proxy | 0.20 | 3-tier cascade: MPNN -> DockingProxy MLP -> constant 0.5 stub | `baselines/scoring.py:202` (`_score_docking_stub`) | Integration complete. VAE trained. MPNN/ADMET in GPU queue (2026-04-05). |
