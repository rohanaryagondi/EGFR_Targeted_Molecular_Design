...
- 14 structures classified into 3 conformational states (DFGin_aCin, DFGin_aCout, DFGout_aCin) -- curated in `features.py:40+`. DFGout_aCout removed: 4ZAU/5D41 reclassified as DFGin.
