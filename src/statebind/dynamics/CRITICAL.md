...
- State aliases at `sequences.py:23-25`: `_ACT=DFGin_aCin`, `_SRC=DFGin_aCout`, `_OUT=DFGout_aCin` (3-state model; `_CLS` removed with DFGout_aCout).
- 3x3 transition matrix (`TransitionMatrix` at `transitions.py:22-29`) uses Laplace smoothing for unseen transitions -- `transitions.py:1-11`.
